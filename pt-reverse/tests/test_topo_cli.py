...
class TopologyCliTest(unittest.TestCase):
    ...
    def test_summarize_query_extracts_links_ip_and_services(self) -> None:
        ...
        self.assertTrue(data["config_summaries"][0]["management"]["enable_secret"])
        self.assertTrue(data["config_summaries"][0]["management"]["service_password_encryption"])
        self.assertEqual(data["config_summaries"][0]["management"]["domain_name"], "campus.local")
        self.assertEqual(data["config_summaries"][0]["management"]["users"][0]["name"], "admin")
        self.assertEqual(data["config_summaries"][0]["management"]["users"][0]["privilege"], "15")
        self.assertTrue(data["config_summaries"][0]["management"]["users"][0]["secret"])
        self.assertEqual(data["config_summaries"][0]["management"]["ssh"]["version"], "2")
        self.assertEqual(data["config_summaries"][0]["management"]["ssh"]["rsa_modulus"], "1024")
        self.assertEqual(data["config_summaries"][0]["management"]["lines"]["console 0"]["password"], True)
        self.assertEqual(data["config_summaries"][0]["management"]["lines"]["vty 0 4"]["transport_input"], ["ssh"])
        self.assertEqual(data["config_summaries"][0]["management"]["banners"][0]["type"], "motd")
