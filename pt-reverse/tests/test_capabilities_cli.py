...
class CapabilitiesCliTest(unittest.TestCase):
    ...
    def test_default_output_is_machine_readable_manifest(self) -> None:
        ...
        self.assertIn("pt-reverse/bin/pt730-render bundle <plan.json> --output-dir <render-dir> --basename topology --formats svg,drawio,html,markdown,summary", data["recommended_workflow"])
        ...
        self.assertIn("MCP pt730_render_bundle creates multi-format SVG/draw.io/HTML/Markdown/summary/course-audit bundles with a manifest in one offline call", data["recommended_workflow"])
