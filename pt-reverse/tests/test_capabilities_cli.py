...
class CapabilitiesCliTest(unittest.TestCase):
    ...
    def test_default_output_is_machine_readable_manifest(self) -> None:
        ...
        self.assertIn("pt-reverse/bin/pt730-render bundle <plan.json> --output-dir <render-dir> --basename topology --formats svg,drawio,html,markdown,summary,diagram-audit --title <title> --legend", data["recommended_workflow"])
        ...
        self.assertIn("MCP pt730_render and pt730_render_bundle expose preset=report for paper theme, auto grouping, legend, hidden link labels, and diagram-audit bundle defaults", data["recommended_workflow"])
        self.assertIn("MCP pt730_render_bundle creates multi-format SVG/draw.io/HTML/Markdown/summary/course-audit/diagram-audit bundles with a manifest in one offline call", data["recommended_workflow"])
