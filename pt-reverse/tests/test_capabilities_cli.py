...
class CapabilitiesCliTest(unittest.TestCase):
    ...
    def test_default_output_is_machine_readable_manifest(self) -> None:
        ...
        self.assertIn("pt-reverse/bin/pt730-lab plan <plan.json> --output-dir <out-dir> --basename topology --formats svg,drawio,html,markdown,summary", data["recommended_workflow"])
        ...
        self.assertIn("pt-reverse/bin/pt730-render bundle <plan.json> --output-dir <render-dir> --basename topology --formats svg,drawio,html,markdown,summary,diagram-audit", data["recommended_workflow"])
