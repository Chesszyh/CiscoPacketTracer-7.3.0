...
class CapabilitiesCliTest(unittest.TestCase):
    ...
    def test_default_output_is_machine_readable_manifest(self) -> None:
        ...
        self.assertIn("MCP pt730_template_lan_star/pt730_template_wireless_lan/pt730_template_vlan_router_on_stick/pt730_template_edge_security/pt730_template_router_ring/pt730_template_wan_ring/pt730_template_campus expose full template CLI options including layout_style/no_layout/compact", data["recommended_workflow"])
        ...
        self.assertIn("MCP pt730_render exposes visual theme/link label/model label/group_by controls for SVG, draw.io, HTML, and Mermaid where supported", data["recommended_workflow"])
