...
class CapabilitiesCliTest(unittest.TestCase):
    ...
    def test_default_output_is_machine_readable_manifest(self) -> None:
        ...
        self.assertIn("MCP pt730_template_lan_star/pt730_template_wireless_lan/pt730_template_router_ring/pt730_template_wan_ring/pt730_template_campus expose full template CLI options including layout_style/no_layout/compact", data["recommended_workflow"])
