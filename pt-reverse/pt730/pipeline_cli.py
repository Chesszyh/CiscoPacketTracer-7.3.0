...
from render_cli import course_audit, drawio, html_report, markdown, summary, svg
...
def schema() -> dict[str, Any]:
    return {
        ...
        "campus": {
            ...
            "optional": ["--compact", "--ip-plan", "--routing none|rip|eigrp|ospf|static", "--layout-style", "--course-audit", "--strict-safety"],
            "outputs": [
                "ip-plan.json",
...
def campus_pipeline(
    *,
    ...
    drawio_out = output_dir / "topology.drawio"
    write_text(drawio_out, drawio(laid_out))
    artifacts["drawio"] = rel(output_dir, drawio_out)
...
def main(argv: list[str] | None = None) -> int:
    ...
    campus_p.add_argument("--routing", choices=("none", "rip", "eigrp", "ospf", "static"), default="rip")
