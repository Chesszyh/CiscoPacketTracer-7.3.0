...
def manifest() -> dict[str, Any]:
    return {
        ...
        "ios_template_features": ["schema", "ip_routing", "vlans", "access_interfaces", "trunks", "routed_interfaces", "spanning_tree", "etherchannel", "dhcp_relay", "hsrp", "ios_dhcp_server", "ntp_client", "syslog_client", "snmp", "ripv2", "eigrp", "ospf", "static_routes", "standard_acls", "extended_acls", "interface_acl_bindings", "nat_overload"],
        ...
        "template_features": ["schema", "lan_star", "dual_stack_lan", "wireless_lan", "vlan_router_on_stick", "switching_lab", "server_services", "edge_security", "router_ring", "wan_ring", "campus", "redundant_campus", "enterprise_edge", "hq_vlans", "server_zone", "branch_wan", "isp_internet", "campus_l3_configs", "dual_core", "dual_homed_access", "etherchannel", "portfast_bpduguard", "hsrp_gateways", "stp_root_roles", "static_host_ips", "ipv6_host_metadata", "ipv6_unicast_routing", "dhcp_client_hosts", "server_dhcp", "router_dhcp_pools", "dhcp_relay", "ios_dhcp_pools", "ntp_syslog_snmp", "wireless_access_points", "laptop_clients", "ssid_metadata", "dot1q_subinterfaces", "trunk_ports", "access_vlan_ports", "dmz_servers", "nat_overload", "outside_acl", "site_lans", "server_http", "server_dns", "server_ftp", "server_tftp", "server_email", "serial_modules", "ripv2", "eigrp", "ospf", "static_routes", "auto_layout"],
