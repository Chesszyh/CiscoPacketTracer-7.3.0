...
def manifest() -> dict[str, Any]:
    return {
        ...
        "ios_template_features": ["schema", "ip_routing", "vlans", "access_interfaces", "trunks", "routed_interfaces", "spanning_tree", "etherchannel", "dhcp_relay", "hsrp", "ios_dhcp_server", "ntp_client", "syslog_client", "snmp", "ripv2", "eigrp", "ospf", "bgp", "static_routes", "standard_acls", "extended_acls", "interface_acl_bindings", "nat_overload"],
        ...
        "query_summary_fields": ["devices", "links", "ip_configs", "ios_devices", "server_services", "config_summaries", "acl_applications", "spanning_tree", "etherchannel", "dhcp_helpers", "hsrp", "ios_dhcp_pools", "ntp", "syslog", "snmp", "bgp"],
