...
def manifest() -> dict[str, Any]:
    return {
        ...
        "mcp_features": ["stdio_jsonrpc", "tools_list", "tools_call", "offline_cli_wrappers", "structured_content", "allow_live_gated_live_tools", "allow_live_gated_device_tools", "live_apply_dry_run", "live_device_dry_run", "live_pc_dhcp_dry_run", "live_server_service_dry_run", "live_ftp_dry_run", "live_sim_dry_run"],
