...
def manifest() -> dict[str, Any]:
    return {
        ...
        "plan_features": ["schema", "new", "add_device", "add_link", "add_annotation", "add_pc_config", "output_file", "compact_json", "mcp_wrappers"],
        ...
        "recommended_workflow": [
            ...
            "MCP pt730_plan_new/pt730_plan_add_device/pt730_plan_add_link/pt730_plan_add_annotation/pt730_plan_add_pc_config let agents build custom topology JSON without hand-editing files",
