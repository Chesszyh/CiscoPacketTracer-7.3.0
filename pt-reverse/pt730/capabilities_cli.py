...
def manifest() -> dict[str, Any]:
    return {
        ...
        "ios_template_features": ["schema", "ip_routing", "vlans", "access_interfaces", "trunks", "routed_interfaces", "ripv2", "ospf", "static_routes", "standard_acls", "extended_acls", "interface_acl_bindings", "nat_overload"],
