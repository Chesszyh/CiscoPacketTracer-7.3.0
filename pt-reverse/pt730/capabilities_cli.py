...
def manifest() -> dict[str, Any]:
    return {
        ...
        "lab_features": ["schema", "template_lab_bundle", "single_spec_input", "template_option_validation", "safety_report", "render_bundle", "config_file_export", "manifest"],
