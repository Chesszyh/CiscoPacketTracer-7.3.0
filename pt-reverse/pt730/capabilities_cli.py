...
def manifest() -> dict[str, Any]:
    return {
        ...
        "query_summary_fields": ["devices", "links", "ip_configs", "ios_devices", "server_services", "config_summaries", "acl_applications", "spanning_tree", "etherchannel", "dhcp_helpers", "hsrp", "ios_dhcp_pools", "ntp", "syslog", "snmp", "bgp", "interface_ipv6_addresses", "ospfv3", "ripng", "ipv6_static_routes"],
