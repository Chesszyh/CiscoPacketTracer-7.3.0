...
def manifest() -> dict[str, Any]:
    return {
        ...
        "lab_features": ["schema", "template_lab_bundle", "plan_lab_bundle", "lab_report_markdown", "single_spec_input", "custom_plan_input", "template_option_validation", "safety_report", "render_bundle", "config_file_export", "manifest"],
        "render_features": ["mermaid", "markdown", "summary", "svg", "drawio", "html", "course_audit", "diagram_audit", "render_bundle", "bundle_manifest", "visual_themes", "visible_titles", "diagram_legends", "link_label_toggle", "model_label_toggle", "visual_group_boxes", "wireless_ap_icons", "wireless_link_styling", "ap_config_summary", "vlan_config_summary", "router_dhcp_pool_summary", "security_policy_summary"],
