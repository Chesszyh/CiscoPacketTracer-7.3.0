...
def manifest() -> dict[str, Any]:
    return {
        ...
        "render_features": ["mermaid", "markdown", "summary", "svg", "drawio", "html", "course_audit", "visual_themes", "link_label_toggle", "model_label_toggle", "visual_group_boxes", "wireless_ap_icons", "wireless_link_styling", "ap_config_summary"],
        "template_features": ["schema", "lan_star", "wireless_lan", "router_ring", "wan_ring", "campus", "campus_l3_configs", "static_host_ips", "wireless_access_points", "laptop_clients", "ssid_metadata", "site_lans", "server_http", "server_dns", "server_ftp", "server_email", "serial_modules", "ripv2", "static_routes", "auto_layout"],
        ...
        "recommended_workflow": [
            ...
            "MCP pt730_template_lan_star/pt730_template_wireless_lan/pt730_template_router_ring/pt730_template_wan_ring/pt730_template_campus expose full template CLI options including layout_style/no_layout/compact",
