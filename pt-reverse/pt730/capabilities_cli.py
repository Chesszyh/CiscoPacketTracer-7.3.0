...
def manifest() -> dict[str, Any]:
    return {
        ...
        "lab_features": ["schema", "template_lab_bundle", "plan_lab_bundle", "lab_report_markdown", "single_spec_input", "custom_plan_input", "template_option_validation", "safety_report", "render_bundle", "report_render_preset", "config_file_export", "manifest"],
        "render_features": ["mermaid", "markdown", "summary", "svg", "drawio", "html", "course_audit", "diagram_audit", "render_bundle", "bundle_manifest", "visual_themes", "report_render_preset", "visible_titles", "diagram_legends", "link_label_toggle", "model_label_toggle", "visual_group_boxes", "wireless_ap_icons", "wireless_link_styling", "ap_config_summary", "vlan_config_summary", "router_dhcp_pool_summary", "security_policy_summary"],
        ...
        "recommended_workflow": [
            ...
            "MCP pt730_render and pt730_render_bundle expose preset=report for paper theme, auto grouping, legend, hidden link labels, and diagram-audit bundle defaults",
            ...
            "pt-reverse/bin/pt730-render bundle <plan.json> --output-dir <render-dir> --basename topology --formats svg,drawio,html,markdown,summary,diagram-audit --title <title> --legend",
