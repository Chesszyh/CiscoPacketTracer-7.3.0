...
def manifest() -> dict[str, Any]:
    return {
        ...
        "plan_features": ["schema", "new", "set_metadata", "remove_device", "remove_module", "remove_link", "remove_ap_config", "remove_annotation", "remove_pc_config", "remove_ipv6_config", "remove_vlan_config", "remove_dhcp_pool", "remove_server_config", "remove_ios_config", "remove_security_policy", "cascade_delete", "reversible_editing", "add_device", "add_module", "add_link", "add_ap_config", "add_annotation", "add_pc_config", "add_ipv6_config", "add_vlan_config", "add_dhcp_pool", "add_server_config", "add_ios_config", "add_security_policy", "ssid_metadata", "serial_modules", "json_object_inputs", "output_file", "compact_json", "mcp_wrappers"],
        "lab_features": ["schema", "template_lab_bundle", "plan_lab_bundle", "lab_report_markdown", "single_spec_input", "custom_plan_input", "template_option_validation", "safety_report", "render_bundle", "report_render_preset", "presentation_render_preset", "verification_plan_artifacts", "config_file_export", "manifest"],
        "render_features": ["render_schema", "mermaid", "markdown", "summary", "svg", "drawio", "html", "course_audit", "diagram_audit", "verification_plan_json", "verification_plan_markdown", "render_bundle", "render_views", "bundle_manifest", "views_manifest", "visual_themes", "report_render_preset", "presentation_render_preset", "visible_titles", "diagram_legends", "link_label_toggle", "model_label_toggle", "visual_group_boxes", "diagram_annotations", "render_time_annotations", "wireless_ap_icons", "wireless_link_styling", "ap_config_summary", "ipv6_config_summary", "vlan_config_summary", "assignment_ip_plan_summary", "website_plan_summary", "router_dhcp_pool_summary", "security_policy_summary"],
        "template_features": ["schema", "lan_star", "dual_stack_lan", "wireless_lan", "vlan_router_on_stick", "switching_lab", "server_services", "edge_security", "router_ring", "wan_ring", "campus", "redundant_campus", "college_network", "enterprise_edge", "hq_vlans", "server_zone", "branch_wan", "isp_internet", "campus_l3_configs", "college_course_ip_plan", "college_website_plan", "six_l3_switch_design", "dual_core", "dual_homed_access", "etherchannel", "portfast_bpduguard", "hsrp_gateways", "stp_root_roles", "static_host_ips", "ipv6_host_metadata", "ipv6_unicast_routing", "dhcp_client_hosts", "server_dhcp", "router_dhcp_pools", "dhcp_relay", "ios_dhcp_pools", "ntp_syslog_snmp", "wireless_access_points", "laptop_clients", "ssid_metadata", "dot1q_subinterfaces", "trunk_ports", "access_vlan_ports", "dmz_servers", "nat_overload", "outside_acl", "site_lans", "server_http", "server_dns", "server_ftp", "server_tftp", "server_email", "serial_modules", "ripv2", "eigrp", "ospf", "bgp_edge", "static_routes", "auto_layout"],
        "mcp_features": ["stdio_jsonrpc", "tools_list", "tools_call", "offline_cli_wrappers", "structured_content", "schema_wrappers", "plan_editor_wrappers", "render_bundle_wrapper", "render_views_wrapper", "verification_plan_wrapper", "lab_bundle_wrapper", "lab_plan_wrapper", "lab_report_wrapper", "template_option_wrappers", "workflow_option_wrappers", "layout_option_wrappers", "config_export_option_wrappers", "catalog_wrappers", "safety_js_wrappers", "allow_live_gated_live_tools", "allow_live_gated_device_tools", "write_gated_model_records", "topo_query_export_wrappers", "model_registry_wrappers", "pkt_open_preflight", "live_lifecycle_dry_run", "live_eval_dry_run", "live_smoke_dry_run", "live_apply_dry_run", "live_device_dry_run", "live_pc_dhcp_dry_run", "live_server_service_dry_run", "live_server_account_config_dry_run", "live_ftp_dry_run", "live_sim_dry_run"],
        "query_summary_fields": ["devices", "links", "ip_configs", "ios_devices", "server_services", "config_summaries", "acl_applications", "spanning_tree", "etherchannel", "dhcp_helpers", "hsrp", "ios_dhcp_pools", "ntp", "syslog", "snmp", "management_access", "bgp", "interface_ipv6_addresses", "ospfv3", "ripng", "ipv6_static_routes", "assignment_ip_plan", "website_plan"],
        "recommended_workflow": [
            ...
            "MCP pt730_plan_new/pt730_plan_set_metadata plus add/remove device/module/link/config metadata tools let agents build and revise custom topology JSON, modules, wireless metadata, annotations, host configs, VLANs, DHCP pools, Server-PT services, IOS configs, and security policies without hand-editing files",
            "MCP pt730_template_lan_star/pt730_template_dual_stack_lan/pt730_template_wireless_lan/pt730_template_vlan_router_on_stick/pt730_template_switching_lab/pt730_template_server_services/pt730_template_edge_security/pt730_template_router_ring/pt730_template_wan_ring/pt730_template_campus/pt730_template_redundant_campus/pt730_template_college_network/pt730_template_enterprise_edge expose full template CLI options including layout_style/no_layout/compact",
            ...
            "pt730-render markdown/summary expose assignment_ip_plan and website_plan fields when present in topology metadata",
            ...
            "MCP pt730_render and pt730_render_bundle expose preset=presentation for dark high-contrast topology screenshots with the same grouping, legend, audit, and verification defaults",
            ...
            "MCP pt730_render_views creates overview plus grouped detail SVG/draw.io/HTML/summary artifacts for large topology plans in one offline call",
            ...
            "MCP pt730_live_app open uses pt730-app .pkt preflight by default; allow_risky=true only passes --allow-risky for supervised recovery attempts",
            ...
            "pt-reverse/bin/pt730-plan remove-ios-config <plan.json> --device R1 --source pt730-plan --output <plan.json>",
            "pt-reverse/bin/pt730-plan remove-server-config <plan.json> --name SRV1 --output <plan.json>",
            ...
            "pt-reverse/bin/pt730-render views <plan.json> --output-dir <render-dir> --basename topology --preset presentation --group-by auto",
