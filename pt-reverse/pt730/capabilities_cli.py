...
def manifest() -> dict[str, Any]:
    return {
        ...
        "plan_features": ["schema", "new", "add_device", "add_link", "add_annotation", "add_pc_config", "add_ipv6_config", "add_vlan_config", "add_dhcp_pool", "add_server_config", "add_ios_config", "add_security_policy", "json_object_inputs", "output_file", "compact_json", "mcp_wrappers"],
