...
def manifest() -> dict[str, Any]:
    return {
        ...
        "render_features": ["mermaid", "markdown", "summary", "svg", "drawio", "html", "course_audit", "diagram_audit", "verification_plan_json", "verification_plan_markdown", "render_bundle", "bundle_manifest", "visual_themes", "report_render_preset", "visible_titles", "diagram_legends", "link_label_toggle", "model_label_toggle", "visual_group_boxes", "wireless_ap_icons", "wireless_link_styling", "ap_config_summary", "vlan_config_summary", "router_dhcp_pool_summary", "security_policy_summary"],
        "template_features": ["schema", "lan_star", "wireless_lan", "vlan_router_on_stick", "switching_lab", "server_services", "edge_security", "router_ring", "wan_ring", "campus", "redundant_campus", "enterprise_edge", "hq_vlans", "server_zone", "branch_wan", "isp_internet", "campus_l3_configs", "dual_core", "dual_homed_access", "etherchannel", "portfast_bpduguard", "hsrp_gateways", "stp_root_roles", "static_host_ips", "dhcp_client_hosts", "server_dhcp", "router_dhcp_pools", "dhcp_relay", "ios_dhcp_pools", "ntp_syslog_snmp", "wireless_access_points", "laptop_clients", "ssid_metadata", "dot1q_subinterfaces", "trunk_ports", "access_vlan_ports", "dmz_servers", "nat_overload", "outside_acl", "site_lans", "server_http", "server_dns", "server_ftp", "server_tftp", "server_email", "serial_modules", "ripv2", "ospf", "static_routes", "auto_layout"],
        "mcp_features": ["stdio_jsonrpc", "tools_list", "tools_call", "offline_cli_wrappers", "structured_content", "schema_wrappers", "render_bundle_wrapper", "verification_plan_wrapper", "lab_bundle_wrapper", "lab_plan_wrapper", "lab_report_wrapper", "template_option_wrappers", "workflow_option_wrappers", "layout_option_wrappers", "config_export_option_wrappers", "catalog_wrappers", "safety_js_wrappers", "allow_live_gated_live_tools", "allow_live_gated_device_tools", "write_gated_model_records", "topo_query_export_wrappers", "model_registry_wrappers", "live_lifecycle_dry_run", "live_eval_dry_run", "live_smoke_dry_run", "live_apply_dry_run", "live_device_dry_run", "live_pc_dhcp_dry_run", "live_server_service_dry_run", "live_server_account_config_dry_run", "live_ftp_dry_run", "live_sim_dry_run"],
        ...
        "recommended_workflow": [
            ...
            "MCP pt730_template_lan_star/pt730_template_wireless_lan/pt730_template_vlan_router_on_stick/pt730_template_switching_lab/pt730_template_server_services/pt730_template_edge_security/pt730_template_router_ring/pt730_template_wan_ring/pt730_template_campus/pt730_template_redundant_campus/pt730_template_enterprise_edge expose full template CLI options including layout_style/no_layout/compact",
            "MCP pt730_ip_plan_campus/pt730_compose_campus/pt730_pipeline_campus expose compact and layout_style workflow controls",
            "MCP pt730_render exposes visual theme/title/legend/link label/model label/group_by controls for SVG, draw.io, HTML, and Mermaid where supported",
