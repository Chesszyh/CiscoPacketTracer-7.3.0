...
def manifest() -> dict[str, Any]:
    return {
        ...
        "ios_template_features": ["schema", "ip_routing", "vlans", "access_interfaces", "trunks", "routed_interfaces", "spanning_tree", "etherchannel", "ripv2", "ospf", "static_routes", "standard_acls", "extended_acls", "interface_acl_bindings", "nat_overload"],
        ...
        "render_features": ["mermaid", "markdown", "summary", "svg", "drawio", "html", "course_audit", "visual_themes", "link_label_toggle", "model_label_toggle", "visual_group_boxes", "wireless_ap_icons", "wireless_link_styling", "ap_config_summary", "vlan_config_summary", "router_dhcp_pool_summary", "security_policy_summary"],
        "template_features": ["schema", "lan_star", "wireless_lan", "vlan_router_on_stick", "edge_security", "router_ring", "wan_ring", "campus", "campus_l3_configs", "static_host_ips", "dhcp_client_hosts", "router_dhcp_pools", "wireless_access_points", "laptop_clients", "ssid_metadata", "dot1q_subinterfaces", "trunk_ports", "access_vlan_ports", "dmz_servers", "nat_overload", "outside_acl", "site_lans", "server_http", "server_dns", "server_ftp", "server_email", "serial_modules", "ripv2", "ospf", "static_routes", "auto_layout"],
        ...
        "query_summary_fields": ["devices", "links", "ip_configs", "ios_devices", "server_services", "config_summaries", "acl_applications", "spanning_tree", "etherchannel"],
        "recommended_workflow": [
            ...
            "MCP pt730_template_lan_star/pt730_template_wireless_lan/pt730_template_vlan_router_on_stick/pt730_template_edge_security/pt730_template_router_ring/pt730_template_wan_ring/pt730_template_campus expose full template CLI options including layout_style/no_layout/compact",
