...
high-level topology composition, deterministic topology auto-layout, safe
topology-plan rendering, and small guarded live operations for the fixed 7.3.0
version used in the coursework.
...
- `pt-reverse/bin/`: command wrappers for launch, bridge, topology, compose,
  layout, render, safety, app, IOS, PC, server, FTP, and terminal helpers.
