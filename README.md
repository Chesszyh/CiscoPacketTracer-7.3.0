...
construct custom topology JSON, serial modules, wireless metadata, and config
metadata through reversible CLI/MCP calls before running layout, render, safety,
config export, or lab bundle commands.
